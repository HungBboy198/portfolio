...
// import plannet10 from './common/images/planet-10.png'
import plance4 from './common/images/plance-4.png'
import cx from 'classnames'
import emailjs from 'emailjs-com'
import { notification } from 'antd'
import { SmileOutlined } from '@ant-design/icons'

interface ContactProps extends elementPublicProps {
...
const Contact = (props: ContactProps) => {
  ...
  if (props.activeElement === 'contact' && !active) {
    setActive(true)
  }
  return (
    <Element className={styles.skill} targetRef={props.targetRef} id='contact'>
      <div className={cx(styles['contact'], !active && styles['hidden'])}>
        {/* <div className={styles['contact__background-bottom']}>
          <img src={plannet10} alt='planet' />
        </div> */}
        <div className={styles['contact__background-plance']}>
          <img src={plance4} alt='plance' />
        </div>
        <div className={styles['contact__title']}>Contact Me</div>
        <div className={styles['contact__left']}>
          <div className={styles['contact__left--title']}>Social Network</div>
          <div className={styles['contact__left--content']}>
            <div className={styles['contact__left--content_item']}>
              <h4>
	...
	c-2.209,0-4-1.791-4-4s1.791-4,4-4c31.984,0,58.006,26.021,58.006,58.006C151.866,109.153,150.075,110.944,147.866,110.944z'
        ...
        <div className={styles['contact__right']}>
          <div className={styles['contact__right--title']}>Let's talk</div>
        ...
        <div className={styles['copy-right']}>
          <div className={styles['copy-right_title']}>Thanks for watching.</div>
          <section>
            © 2023
            <span>
              <svg
